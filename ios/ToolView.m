...
//    选择动画的添加
    ...
    widthBgImageView.backgroundColor = [UIColor whiteColor];
    widthBgImageView.alpha = 0.5;
...
- (void)_creatColorView {
    ...
    colorBgImageView.backgroundColor = [UIColor whiteColor];
    colorBgImageView.alpha = 0.4;
